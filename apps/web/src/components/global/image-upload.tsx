...
export default function ImageUpload({ className }: ComponentProps<'div'>) {
  const [
    { files, isDragging },
    {
      handleDragEnter,
      ...
      <div className='relative inline-flex'>
        ...
        >
          {finalImageUrl ? (
            ...
            >
              <ImagePlusIcon className='size-6 opacity-60' />
